...
public class SymbolTableTest {
    ...
    static JmmSemanticsResult test(String filename, boolean fail) {
        ...
        if (!semantics.getReports().isEmpty()) {
            System.out.println(semantics.getReports());
        }
        return semantics;
    }
    ...
    public void DuplicateImport() {
        test("symboltable/_DuplicateImport.jmm", false);
    }

    @Test
    public void DuplicateField() {
        test("symboltable/_DuplicateField.jmm", true);
    }

    @Test
    public void DuplicateLocal() {
        test("symboltable/_DuplicateLocal.jmm", true);
    }

    @Test
    public void DuplicateMethod() {
        test("symboltable/_DuplicateMethod.jmm", true);
    }

    @Test
    public void DuplicateParam() {
        test("symboltable/_DuplicateParam.jmm", true);
    }

    @Test
    public void VarargField() {
        test("symboltable/_VarargField.jmm", true);
    }

    @Test
    public void VarargLocal() {
        test("symboltable/_VarargLocal.jmm", true);
    }

    @Test
    public void VarargReturn() {
        test("symboltable/_VarargReturn.jmm", true);
    }

    @Test
    public void VarargNotLastParam() {
        test("symboltable/_VarargNotLastParam.jmm", true);
    }

    @Test
    public void MultipleVarargs() {
        test("symboltable/_MultipleVarargs.jmm", true);
    }

    @Test
    public void NoSuperclassImport() {
        test("symboltable/_NoSuperclassImport.jmm", true);
    }

    @Test
    public void LocalAndParamConflict() {
        test("symboltable/_LocalAndParamConflict.jmm", true);
    }

    @Test
    public void ConflictingImports() { test("symboltable/_ConflictingImports.jmm", true); }

    @Test
    public void VoidField() { test("symboltable/_VoidField.jmm", true); }
}
