...
public class OptimizationsTest {
    ...
    @Test
    public void _constPropAndFold() {

        String filename = "const_prop_fold/_constPropAndFold.jmm";
    ...
    @Test
    public void _ConstPropIntoIf() {

        String filename = "const_prop_fold/_constPropIntoIf.jmm";
