...
public class JasminTest {
    ...
    public void CustomTest() {
        String filePath = "pt/up/fe/comp/cp3/jasmin/Test.jmm";
        // apply optimizations to ollir
        Map<String, String> config = new HashMap<>();
        config.put(ConfigOptions.getOptimize(), "true");
        config.put(ConfigOptions.getRegister(), "0");
        var ollirResult = CpUtils.getOllirResult(SpecsIo.getResource(filePath), config, false);
